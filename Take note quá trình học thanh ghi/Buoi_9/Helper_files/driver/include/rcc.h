...
// lỗi : Khai báo biến RCC_BITBAND và gán cứng vào vùng nhớ Bit-band alias của địa chỉ RCC (0x40021000)
//__root __no_init volatile RCC_BITBAND_TypeDef RCC_BITBAND @ BITBAND_PERIPHERAL_ADDRESS(0x40021000, 0);
// Thay thế macro bằng địa chỉ cứng đã tính toán sẵn: 0x42420000
__root __no_init volatile RCC_BITBAND_TypeDef RCC_BITBAND @ 0x42420000;
//==============================================================================================================================================================
//===========================================================       LEVEL 1      ===============================================================================
//==============================================================================================================================================================
typedef struct
