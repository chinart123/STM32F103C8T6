...
//  union 
//  {
//    unsigned long REG; // Dùng để gán trực tiếp giá trị: TIM1.PSC.REG = 7999;
//    struct 
//    {
//      unsigned long b0  : 1; // Bit 0 (trọng số 1)
//      unsigned long b1  : 1; // Bit 1 (trọng số 2)
//      unsigned long b2  : 1; // ...
//      unsigned long b3  : 1;
//      unsigned long b4  : 1;
//      unsigned long b5  : 1;
...
//      unsigned long b14 : 1;
//      unsigned long b15 : 1;
//      unsigned long _reserved : 16; // 16 bit cao không dùng
//    } BITS;
//  } PSC;
