...
| [KI-ENV-0007](categories-by-origin/host-environment/KI-ENV-0007__preprocessor-if-noninteger-stage-label/) | `#if STAGE == 0_1` với nhãn `0_1/0_2/0_3` → Pe014 (nhãn là pp-number, không phải hằng số nguyên); sửa bằng `#ifdef` | language, host-environment | fixed |
